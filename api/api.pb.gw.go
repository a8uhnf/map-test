...
var (
	filter_Ping_SayHello_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_Ping_SayHello_0(ctx context.Context, marshaler runtime.Marshaler, client PingClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_Ping_SayHello_0); err != nil {
...
// RegisterPingHandler registers the http handlers for service Ping to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "PingClient".
...
var (
	pattern_Ping_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"hello"}, ""))
)
